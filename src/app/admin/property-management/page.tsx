...
import { PropertyStatus, Property, PropertyTableProps } from "@/lib/props";
import { propertyManagementButtons } from "@/components/data/array";
      ...
      <PageHeader>
        ...
        <Tabs defaultValue="Pending" onValueChange={handleTabChange}>
          <TabsList className="grid w-full grid-cols-5 max-w-2xl bg-transparent p-0">
            {propertyManagementButtons.map((button, index) => (
              <TabsTrigger
                key={index}
                value={button.name}
