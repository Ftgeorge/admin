...
export default function SettingsPage() {
  ...
  const ActiveSettingComponent =
    settingsCategories[activeSettingIndex].component;
    ...
    <PageContainer>
      <PageHeader>
        ...
        <p className="text-gray-500">
          Manage your platform configuration and policies
        </p>
      </PageHeader>
            ...
            {settingsCategories.map((setting, index) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 h-12 text-left transition-all ${
                    isActive
                      ? "border-b-2 border-primary text-primary"
                      : "border-b-2 border-transparent text-mutedText"
                  }`}
                >
                  <IconComponent
                    className={`h-5 w-5 ${
